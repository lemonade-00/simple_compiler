...
{
       0,     0,     3,     4,     8,    12,    16,    18,    20,    25,
      29,    32,    34,    36,    39,    42,    46,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      10,     0,    -1,    -1,    10,    11,     8,    -1,    11,     5,
      12,    -1,    11,     7,    12,    -1,    12,    -1,    13,    -1,
       3,     4,     6,     3,    -1,     4,     6,     3,    -1,     3,
       4,    -1,     4,    -1,     3,    -1,     7,     3,    -1,     7,
       4,    -1,     7,     3,     4,    -1,     7,     4,     6,     3,
      -1,     7,     3,     4,     6,     3,    -1
...
{
  "$end", "error", "$undefined", "NUMBER", "X", "PLUS", "EXP", "MINUS",
  "EOL", "$accept", "calclist", "expression", "term", "factor", 0
};
#endif
...
{
       2,     0,     1,    12,    11,     0,     0,     6,     7,    10,
       0,    13,    14,     0,     0,     3,     0,     9,    15,     0,
       4,     5,     8,     0,    16,    17
};
...
{
      -3,     0,    -3,    10,     9,     7,     1,    -3,    -3,    11,
      13,    14,    15,    -2,    -2,    -3,    16,    -3,    17,    19,
      -3,    -3,    -3,    21,    -3,    -3
};
...
{
       2,     3,     4,     3,     4,     5,    13,     5,    14,    15,
      11,    12,    20,    21,     9,    10,    17,    16,    18,    22,
       0,    19,    24,    23,    25
};
...
/* Line 1455 of yacc.c  */
#line 130 "example.y"
    { print_polynomial((yyvsp[(2) - (3)].poly)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 134 "example.y"
    { (yyval.poly) = add_polynomials((yyvsp[(1) - (3)].poly), (yyvsp[(3) - (3)].poly)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 135 "example.y"
    { (yyval.poly) = minus_polynomials((yyvsp[(1) - (3)].poly), (yyvsp[(3) - (3)].poly)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 144 "example.y"
    { (yyval.poly) = create_polynomial((yyvsp[(1) - (4)].num), (yyvsp[(4) - (4)].num)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 145 "example.y"
    { (yyval.poly) = create_polynomial(1, (yyvsp[(3) - (3)].num)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 146 "example.y"
    { (yyval.poly) = create_polynomial((yyvsp[(1) - (2)].num), 1); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 147 "example.y"
    { (yyval.poly) = create_polynomial(1, 1); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 148 "example.y"
    { (yyval.poly) = create_polynomial((yyvsp[(1) - (1)].num), 0); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 149 "example.y"
    { (yyval.poly) = create_negpolynomial((yyvsp[(2) - (2)].num), 0); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 150 "example.y"
    { (yyval.poly) = create_negpolynomial(1, 1); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 151 "example.y"
    { (yyval.poly) = create_negpolynomial((yyvsp[(2) - (3)].num), 1); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 152 "example.y"
    { (yyval.poly) = create_negpolynomial(1, (yyvsp[(4) - (4)].num)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 153 "example.y"
    { (yyval.poly) = create_negpolynomial((yyvsp[(2) - (5)].num), (yyvsp[(5) - (5)].num)); ;}
    break;
